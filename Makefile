...
build/debug/lydrige: build/debug/libmpc.a build/debug/libhashmap.a src/main/c/main.c src/main/c/builtin.c src/main/c/structure.c src/main/headers/builtin.h src/main/headers/structure.h
	mkdir -p build/debug
	gcc -std=c99 -Wall -g src/main/c/*.c build/debug/libmpc.a build/debug/libhashmap.a -lreadline -lm -o build/debug/lydrige

build/release/lydrige: build/release/libmpc.a build/release/libhashmap.a src/main/c/main.c src/main/c/builtin.c src/main/c/structure.c src/main/headers/builtin.h src/main/headers/structure.h
