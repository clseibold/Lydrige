...
enum { DDATA_ANY, DDATA_RANGE, DDATA_INT, DDATA_DOUBLE, DDATA_BYTE, DDATA_STRING, DDATA_CHAR, DVAL_ERR, DVAL_SYM, DVAL_TYPE, DVAL_SSEXPR, DVAL_SEXPR, DVAL_SQEXPR, DVAL_QEXPR, DVAL_SLIST, DVAL_LIST, DVAL_FUNC, DVAL_NOTE };
