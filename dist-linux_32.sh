...
gcc -m32 -std=c99 -Wall -O3 src/main/c/*.c build/dist/x86/libmpc.a build/dist/x86/libhashmap.a build/dist/x86/liblinenoise.a -lreadline -lm -o build/dist/x86/Lydrige-linux_x86_bin-v060a